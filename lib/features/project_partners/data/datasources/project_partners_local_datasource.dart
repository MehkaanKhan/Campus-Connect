...
class ProjectPartnersLocalDataSource {
  List<ProjectPartnerEntity> getProjects() => [
        ProjectPartnerEntity(
          ...
          badgeColor: AppColors.toHex(AppColors.sage),
          ...
          skills: const ['Swift / iOS', 'Node.js', 'Google Maps API'],
        ),
        ProjectPartnerEntity(
          id: '2',
          creatorId: 'mock_user',
          badge: 'STARTUP IDEA',
          badgeColor: AppColors.toHex(AppColors.badgeStartupText),
          ...
          skills: const ['Figma', 'User Research'],
        ),
        ProjectPartnerEntity(
          id: '3',
          creatorId: 'mock_user',
          badge: 'HACKATHON',
          badgeColor: AppColors.toHex(AppColors.badgeHackathonText),
          ...
          skills: const ['Python', 'Prompt Engineering'],
        ),
      ];
